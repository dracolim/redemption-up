...
export const FlowerVectorSvg = () => {
    return (
        <svg width="225" height="286" viewBox="0 0 225 286" fill="none" xmlns="http://www.w3.org/2000/svg" className="absolute top-8 inset-y-0 right-0">
            <g style={{ mixBlendMode: "multiply"}} opacity="0.2">
                <path d="M259.309 168.645L258.697 167.68C246.28 148.535 227.322 136.148 206.643 131.468C224.843 119.86 238.537 101.321 243.543 78.6128C220.862 73.4853 198.259 77.9948 180.013 89.529C184.653 68.4591 181.27 45.6617 168.705 26.0383C149.048 38.468 136.23 57.6482 131.468 78.691C119.86 60.4914 101.321 46.7967 78.6128 41.7906C73.4853 64.4717 77.9948 87.0747 89.529 105.321C68.4591 100.681 45.6617 104.064 26.0383 116.629C38.468 136.286 57.6482 149.104 78.6909 153.866C60.849 165.299 47.2627 183.353 42.048 205.568L41.7906 206.721L42.9435 206.979C65.2676 211.708 87.4458 207.104 105.321 195.805C100.762 216.511 103.984 238.89 115.955 258.317L116.568 259.282L117.533 258.669C136.677 246.253 149.125 227.308 153.745 206.616C165.178 224.458 183.231 238.044 205.447 243.259L206.6 243.516L206.857 242.363C211.587 220.039 206.982 197.861 195.684 179.986C216.389 184.545 238.769 181.323 258.196 169.352L259.309 168.645Z" fill="#EA193F" fill-opacity="0.5"/>
            </g>
            <g style={{ mixBlendMode: "multiply"}} opacity="0.2">
                <path d="M244.559 165.872L244.026 165.032C233.22 148.371 216.721 137.591 198.724 133.518C214.563 123.415 226.481 107.281 230.838 87.5179C211.099 83.0555 191.428 86.9802 175.548 97.0182C179.586 78.6813 176.642 58.8409 165.707 41.7628C148.6 52.5802 137.444 69.2726 133.3 87.586C123.197 71.7471 107.063 59.8286 87.3002 55.4719C82.8378 75.2111 86.7625 94.8823 96.8005 110.762C78.4636 106.724 58.6232 109.668 41.5451 120.603C52.3625 137.71 69.0549 148.866 87.3683 153.01C71.8406 162.961 60.0165 178.672 55.4782 198.007L55.2542 199.01L56.2576 199.234C75.6861 203.35 94.9876 199.343 110.544 189.51C106.577 207.53 109.381 227.006 119.799 243.913L120.332 244.753L121.172 244.22C137.833 233.414 148.666 216.927 152.687 198.918C162.637 214.446 178.349 226.27 197.683 230.808L198.687 231.032L198.911 230.029C203.026 210.6 199.019 191.299 189.186 175.742C207.206 179.71 226.683 176.906 243.59 166.487L244.559 165.872Z" fill="#EA193F" fill-opacity="0.5"/>
            </g>
        </svg>
    );
};
...
export const ArrowLeftSvg = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#F5F5F5" viewBox="0 0 256 256"><path d="M224,128a8,8,0,0,1-8,8H59.31l58.35,58.34a8,8,0,0,1-11.32,11.32l-72-72a8,8,0,0,1,0-11.32l72-72a8,8,0,0,1,11.32,11.32L59.31,120H216A8,8,0,0,1,224,128Z"></path></svg>
    )
};

export const HeadsUpSvg = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" fill="#FFFFFF" viewBox="0 0 256 256"><path d="M176,232a8,8,0,0,1-8,8H88a8,8,0,0,1,0-16h80A8,8,0,0,1,176,232Zm40-128a87.55,87.55,0,0,1-33.64,69.21A16.24,16.24,0,0,0,176,186v6a16,16,0,0,1-16,16H96a16,16,0,0,1-16-16v-6a16,16,0,0,0-6.23-12.66A87.59,87.59,0,0,1,40,104.49C39.74,56.83,78.26,17.14,125.88,16A88,88,0,0,1,216,104Zm-16,0a72,72,0,0,0-73.74-72c-39,.92-70.47,33.39-70.26,72.39a71.65,71.65,0,0,0,27.64,56.3A32,32,0,0,1,96,186v6h64v-6a32.15,32.15,0,0,1,12.47-25.35A71.65,71.65,0,0,0,200,104Zm-16.11-9.34a57.6,57.6,0,0,0-46.56-46.55,8,8,0,0,0-2.66,15.78c16.57,2.79,30.63,16.85,33.44,33.45A8,8,0,0,0,176,104a9,9,0,0,0,1.35-.11A8,8,0,0,0,183.89,94.66Z"></path></svg>
    )
};

export const CrossSVG = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#fffefa" viewBox="0 0 256 256"><path d="M205.66,194.34a8,8,0,0,1-11.32,11.32L128,139.31,61.66,205.66a8,8,0,0,1-11.32-11.32L116.69,128,50.34,61.66A8,8,0,0,1,61.66,50.34L128,116.69l66.34-66.35a8,8,0,0,1,11.32,11.32L139.31,128Z"></path></svg>
    )
};
